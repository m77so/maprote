// To parse this data:
//
//   import { Convert, Quest } from "./file";
//
//   const quest = Convert.toQuest(json);
//
...
export class Convert {
    public static toQuest(json: string): Quest {
        return cast(JSON.parse(json), r("Quest"));
    }

    public static questToJson(value: Quest): string {
        return JSON.stringify(uncast(value, r("Quest")), null, 2);
    }
}
